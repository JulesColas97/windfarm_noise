...
!*******************************************************************************
subroutine write_3Dfield_SinglePrecision(version,var,varname,folder,nzsize,nz_local)
use param,only: sp,rp,nx,ny,nz,nz_tot,jt_total,localComm,coord
use mpi, only: mpi_info_null
use hdf5
implicit none
real(sp), dimension(1:nx,1:ny,1:nz_local), intent(IN) :: var
...
call h5dcreate_f(file_id,'var',H5T_NATIVE_REAL,filespace,dset_name,hdf_error)
...
call h5dwrite_f(dset_name, H5T_NATIVE_REAL, var(1:nx,1:ny,1:nz_local), dims,& 
...
end subroutine write_3Dfield_SinglePrecision 
