subroutine write_PDF(version,var,varname,folder,nzsize,nz_local)
use param,only:nbins,rp,nz,nz_tot,kmax,jt_total,localComm,coord
use mpi, only: mpi_info_null
use hdf5
      implicit none
      real(rp), dimension(1:nbins,1:nz_local), intent(IN) :: var
