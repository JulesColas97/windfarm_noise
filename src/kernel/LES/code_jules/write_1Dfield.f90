!     subroutine write_1dfield(version,var,varname,folder)
...
subroutine write_1Dfield(version,var,varname,folder,nzsize,nz_local)
use param,only:lprec,rp,nz,nz_tot,kmax,jt_total,localComm,coord
use mpi, only: mpi_info_null
use hdf5
implicit none
real(lprec), dimension(1:nz_local), intent(IN) :: var
