!*******************************************************************************
! subroutine read_streamw_spec(var,varname,folder)
...
!*******************************************************************************
subroutine read_streamw_spec(var,varname,folder,nzsize,nz_local)
use param,only:rp,nx,nz,nz_tot,lprec,localComm,mpi_info_null,coord,ierr,mpi_comm_world
use hdf5
implicit none
real(lprec), dimension(1:nx/2+1,1:nz_local), intent(out) :: var
real(rp),dimension(1:nx/2+1,1:nz_local) :: var_local
...
if(exst) then 
   ...
   call h5dread_f(dset_name,H5T_NATIVE_DOUBLE, var_local(1:nx/2+1,1:nz_local),dims,&
...
end subroutine read_streamw_spec 
