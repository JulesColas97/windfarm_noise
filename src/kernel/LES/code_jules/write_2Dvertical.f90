!     subroutine write_2dvertical(version,var,varname,folder)
...
!     nz_local: Define local top boundary in the file
      subroutine write_2Dvertical(version,var,varname,folder,nzsize,nz_local)
      use param,only:rp,nx,ny,nz,nz_tot,kmax,jt_total,localComm,mpi_info_null,coord
      use hdf5
      implicit none
      real(rp), dimension(1:nx,1:nz_local), intent(IN) :: var
...
!     Write variable in HDF5 file
      ...
      end subroutine write_2Dvertical
