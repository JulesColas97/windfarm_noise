      subroutine write_streamw_spec(version,var,varname,folder,nzsize,nz_local)
      use param,only:nx,rp,nz,nz_tot,kmax,jt_total,localComm,mpi_info_null,coord
      use hdf5
      implicit none
      real(rp), dimension(1:nx/2+1,1:nz_local), intent(IN) :: var
...
!     Write variable in HDF5 file
      ...
      end subroutine write_streamw_spec
