...
PACKAGE_DIR = FILE.parents[2] / "src/prepost"
REFERENCE_DIR = PACKAGE_DIR.parent / "docs/reference"
# REFERENCE_DIR = FILE.parents[2] / "docs/reference"
...
def create_markdown(
    ...
    md_content = ["<br>\n"] + [
        f"## ::: src.{module_name}.{class_name}\n\n<br><br><hr><br>\n"
        for class_name in classes
    ]
    md_content.extend(
        f"## ::: src.{module_name}.{func_name}\n\n<br><br><hr><br>\n"
